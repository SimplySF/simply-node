# Contributing to @simplysf/simply-core

Shared internal utilities for SimplySF Salesforce CLI plugins. This package is part of the [`simply-plugins-core`](https://github.com/SimplySF/simply-plugins-core) monorepo.
