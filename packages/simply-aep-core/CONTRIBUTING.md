...
Apex Enterprise Patterns (fflib, force-di, AT4DX) scan and resolution logic. This package is part of the [`simply-node`](https://github.com/SimplySF/simply-node) monorepo.
