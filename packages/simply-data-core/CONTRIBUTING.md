# Contributing to @simplysf/simply-data-core

Content Version upload/download and CSV row counting logic. This package is part of the [`simply-plugins-core`](https://github.com/SimplySF/simply-plugins-core) monorepo.
