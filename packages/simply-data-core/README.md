...
| `ContentVersion`, `ContentVersionCreateRequest`, `ContentVersionCreateResult`, `ContentVersionDownload`, `ContentVersionToUpload`, `ContentVersionMultipart` | Types for the `ContentVersion` upload/download functions and the multipart body builder.                           |
| `ContentNoteInput`, `ContentNoteResult`, `ContentNoteSuccessResult`, `ContentNoteErrorResult`, `UploadContentNotesOptions`                                   | Input, per-note result, and option types for `createContentNote`/`uploadContentNotes`.                             |
