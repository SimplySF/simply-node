...
Engine for standardizing a Salesforce DX project's files, `.gitignore`, and `package.json` dependencies/scripts from a consumer-supplied set of template packs, presets, and defaults. This package is part of the [`simply-plugins-core`](https://github.com/SimplySF/simply-plugins-core) monorepo.
