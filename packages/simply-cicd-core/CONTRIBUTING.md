...
ALM issue linking (Jira, GitLab Issues) and VCS API clients (GitHub, GitLab). This package is part of the [`simply-plugins-core`](https://github.com/SimplySF/simply-plugins-core) monorepo.
