# Contributing to @simplysf/simply-community-core

Community publish/deploy/domain-verification logic and site-file discovery. This package is part of the [`simply-plugins-core`](https://github.com/SimplySF/simply-plugins-core) monorepo.
