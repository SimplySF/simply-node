...
Community publish/deploy/domain-verification logic and site-file discovery. This package is part of the [`simply-node`](https://github.com/SimplySF/simply-node) monorepo.
